...
$where = " AND p.status = 'Y' AND pr.event_id = $eventId AND st.event_id = $eventId";
$resProducts = $prices->getProductsWithPrice($where, "p.name ASC");
                        ...
                        <form id="frm-orders" data-parsley-validate="">
                            ...
                            <div style="border-left: 1px solid #ccc;">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <br>
                                        <input type="checkbox" id="good_for" name="good_for">
                                        <label for="good_for">Utang</label>
                                    </div>
                                </div>
                            </div>                            
                        </form>
...
<script>
    $(document).ready(function(){
        ...
        $('#good_for').change(function(){
            $('#cash').attr('data-parsley-required','');
            if($(this).is(':checked')){
                $('#cash').removeAttr('data-parsley-required');
                $('#cash').val('0.00');
                $('#change').val('0.00');
            }
        })
