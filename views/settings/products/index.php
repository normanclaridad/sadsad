            ...
            <div class="modal-body">
                <form id="frm-products" data-parsley-validate="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Product Name" autocomplete = "off" data-parsley-required=""/>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function(){
        ...
        var table = $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/settings/products/get.php',
                type: 'POST',
                data:   function ( d ) {
                    return $.extend( {}, d, {
                        // 'action' : getAction()
        ...
        $('#btn-save').click(function()
        {
            ...
            if(confirm('Are all data is correct?')){ 
                $.ajax({
                    url : '<?php echo BASE_URL ?>/api/settings/products/dml.php',
                    type : 'post',
